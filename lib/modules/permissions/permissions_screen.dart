                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            filled: true,
                            fillColor: themeController.isDarkMode.value?AppColors.componentDark :Colors.grey[500]!.withOpacity(0.16),
                            hintText: 'Search for the name',
                            hintStyle: TextStyle(color: themeController.isDarkMode.value?AppColors.white :Color(0xFF4A4A4C)),
